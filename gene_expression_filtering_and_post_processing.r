...
d <- read.csv("GeneExpression.bed.csv", header = TRUE,sep=";") ##for raw counts
...
write.table(dfilt, "GeneExpression.filter-nonZero90.bed", sep = "\t", quote = FALSE, col.names = TRUE, row.names = FALSE)
